...
public class ControleurForme extends Application {
	...
	private void genererButtons() {
		buttonGenerer = (Button) ((HBox) root.getChildren().get(0)).getChildren().get(0);
		buttonReinitialiser = (Button) ((HBox) root.getChildren().get(0)).getChildren().get(1);
		buttonQuitter = (Button) ((HBox) root.getChildren().get(0)).getChildren().get(2);
	...
	private void genererListe() {
		listFormes = (ListView<TextFlow>) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(0)).getChildren()
				.get(1);
	...
	private void genererChosen() {
		theChosenOne = (ColorPicker) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(1)).getChildren()
				.get(1);
	}

	private void genererEffet() {
		chkBxEffet = (CheckBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(2)).getChildren().get(1);
	...
	private void genererPositionX() {
		lbX = (Label) ((VBox) ((HBox) ((VBox) root.getChildren().get(1)).getChildren().get(3)).getChildren().get(0))
				.getChildren().get(0);
		txtFldPositionX = (TextField) ((VBox) ((HBox) ((VBox) root.getChildren().get(1)).getChildren().get(3))
				.getChildren().get(0)).getChildren().get(1);
	}

	private void genererPositionY() {
		lbY = (Label) ((VBox) ((HBox) ((VBox) root.getChildren().get(1)).getChildren().get(3)).getChildren().get(1))
				.getChildren().get(0);
		txtFldPositionY = (TextField) ((VBox) ((HBox) ((VBox) root.getChildren().get(1)).getChildren().get(3))
				.getChildren().get(1)).getChildren().get(1);
	}

	private void genererCotes() {
		genererCoteA();
		genererCoteB();
		genererCoteC();
	}

	private void genererCoteA() {
		lbA = (Label) ((VBox) ((HBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4)).getChildren()
				.get(0)).getChildren().get(0)).getChildren().get(0);
		txtFldCoteA = (TextField) ((VBox) ((HBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4))
				.getChildren().get(0)).getChildren().get(0)).getChildren().get(1);
	}

	private void genererCoteB() {
		lbB = (Label) ((VBox) ((HBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4)).getChildren()
				.get(0)).getChildren().get(1)).getChildren().get(0);
		txtFldCoteB = (TextField) ((VBox) ((HBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4))
				.getChildren().get(0)).getChildren().get(1)).getChildren().get(1);
	}

	private void genererCoteC() {
		txtFldCoteC = (TextField) ((VBox) ((HBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4))
				.getChildren().get(0)).getChildren().get(2)).getChildren().get(1);
	}

	private void genererIO() {
		io = (Slider) ((VBox) ((VBox) ((VBox) root.getChildren().get(1)).getChildren().get(4)).getChildren().get(1))
				.getChildren().get(1);
	}

	private void genererPn() {
		pn = (StackPane) root.getChildren().get(2);
	}
